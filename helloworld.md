...
\* $41\_{16} = 0100 0001\_2$ (รหัส ASCII ของตัวอักษร 'A')

\* $42\_{16} = 0100 0010\_2$ (รหัส ASCII ของตัวอักษร 'B')



\### 3.2 การแปลงเลขฐานสิบที่มีทศนิยม เป็นฐานสอง

ตัวอย่างการแปลงค่า $10.625\_{10}$:

1\.  \*\*ส่วนจำนวนเต็ม (10):\*\* หารสั้นด้วย 2 จะได้ $1010\_2$
...
3\.  \*\*ผลลัพธ์:\*\* $10.625\_{10} = 1010.101\_2$
...
&nbsp;   \* ตัวอย่าง: $5 \\ll 1$ ($0000 0101\_2$ เลื่อนเป็น $0000 1010\_2$) ผลลัพธ์คือ $10\_{10}$

&nbsp;   \* ตัวอย่าง: $5 \\ll 2$ ผลลัพธ์คือ $20\_{10}$
...
ในยุคของ CPU Intel 8086 (สถาปัตยกรรม 16 บิต) มีข้อจำกัดคือ Register ภายในมีขนาดเพียง 16 บิต ซึ่งอ้างอิงตำแหน่งได้สูงสุดเพียง $FFFF\_{16}$ หรือ $64\\text{ KB}$ แต่ตัวเมนบอร์ดรองรับหน่วยความจำทางกายภาพ (Physical Memory) ได้ถึง 20 บิต ($1\\text{ MB}$)
